...
void main() {
    // put custom character set into memory at $C000
  ...
  *(unsigned char*)0xDD00 &= 0xFC;
    ...
    // 53272 is the VIC-II control register for character ROM location ($D018)
    // Setting to 32 (binary %00100000) tells VIC-II to use character ROM at $C000 (49152)
   // POKE(53272UL,32); 
  *(unsigned char*)0xD018 = 32;
  
    
    // 3. Set the cursor character to use our custom character set
    // 648 is the cursor character location in memory ($0288)
